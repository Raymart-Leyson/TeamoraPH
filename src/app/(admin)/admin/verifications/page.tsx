                        ...
                        <Card key={request.id} className="border-none shadow-xl rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden bg-white/60 backdrop-blur-md">
                            <CardContent className="p-4 sm:p-8">
                                <div className="flex flex-col md:flex-row gap-8">
                                    ...
                                    >
                                        <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-[#1B3FA0]/5 flex items-center justify-center border border-[#1B3FA0]/10 group-hover:bg-[#1B3FA0]/10 transition-colors">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs font-bold text-[#3D6EFF] mt-1 group-hover:underline flex items-center gap-1">
                                    ...
                                    <div className="flex-1 space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <p className="text-xs font-black uppercase tracking-widest text-[#1B3FA0]/40">Attached Documents</p>
                                                ...
                                                {request.documents && request.documents.length > 0 ? (
                                                    request.documents.map((doc: string, idx: number) => (
                                                        <a
                                                            ...
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            className="flex items-center gap-2 px-4 py-2 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow text-sm font-bold text-[#1B3FA0]"
                                                        >
