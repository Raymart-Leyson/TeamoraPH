    ...
    return (
        <>
            ...
            <div className="lg:hidden flex-1 bg-[#123C69]/[0.02] min-h-screen p-4 pt-4">
                <div className="mb-4">
                    <h2 className="text-xl font-black text-[#123C69] tracking-tight">Messages</h2>
                    <p className="text-[#123C69]/60 font-medium mt-1 text-sm">Chat directly with potential hire teams.</p>
                </div>
