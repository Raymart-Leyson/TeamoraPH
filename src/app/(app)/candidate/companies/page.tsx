...
export default async function CandidateBrowseCompaniesPage({
    ...
    return (
        <div className="flex-1 p-4 md:p-6 max-w-[90%] mx-auto pt-6 space-y-6">
            {/* Header */}
            <div>
                <h2 className="text-2xl font-extrabold tracking-wide text-[#1B3FA0]">Browse Companies</h2>
                                ...
                                <Card className="h-full hover:border-[#1B3FA0]/40 hover:shadow-md transition-all duration-200 cursor-pointer group">
                                    <CardContent className="p-4 md:p-5 flex flex-col gap-4">
                                        ...
                                        <div className="flex-1 space-y-1">
                                            <h3 className="font-semibold text-lg leading-tight group-hover:text-[#1B3FA0] transition-colors">
                                                {company.name}
                                            </h3>
                                            {company.description && (
                                        ...
                                        <div className="flex items-center justify-between pt-2 border-t">
                                            <Badge
                                                variant="secondary"
                                                className="flex items-center gap-1 bg-[#A8C4FF]/40 text-[#1B3FA0] border-none font-bold"
                                            >
