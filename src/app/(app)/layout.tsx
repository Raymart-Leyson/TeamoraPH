...
import { Menu, UserCircle2, Bell, LayoutDashboard, User, FileText, Bookmark, Settings, Briefcase, FilePlus, CreditCard, Users, Clock } from "lucide-react";
            ...
            <div className="flex flex-col flex-1 h-screen overflow-hidden">
                ...
                <header className="flex h-16 items-center gap-4 border-b bg-muted/10 px-6 shrink-0 z-10 w-full lg:px-8">
                    ...
                    <div className="w-full flex-1">
                        <h1 className="font-semibold text-lg lg:hidden">Teamora<span className="text-[#3D6EFF]">PH</span></h1>
                    </div>
