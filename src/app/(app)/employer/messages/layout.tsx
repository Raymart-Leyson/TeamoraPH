...
export default function EmployerMessagesLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="p-4 md:p-6 lg:p-8 bg-[#1B3FA0]/[0.02] h-[calc(100vh-4rem)] flex flex-col">
            {/* Card shell */}
            <div className="flex flex-1 overflow-hidden rounded-2xl border border-white/60 bg-white/60 backdrop-blur-xl shadow-xl">
                ...
                <aside className="hidden lg:flex lg:w-[30%] flex-col border-r border-[#1B3FA0]/10 overflow-hidden">
                    <InboxList role="employer" sidebar />
                </aside>
