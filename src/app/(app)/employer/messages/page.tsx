    ...
    return (
        <>
            ...
            <div className="lg:hidden flex-1 bg-[#1B3FA0]/[0.02] min-h-screen p-4 pt-4">
                <div className="mb-4">
                    <h2 className="text-xl font-black text-[#1B3FA0] tracking-tight">Inbox</h2>
                    <p className="text-[#1B3FA0]/60 font-medium mt-1 text-sm">Manage your conversations with top talent.</p>
                </div>
