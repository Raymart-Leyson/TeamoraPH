                    ...
                    <Card className="flex-1 bg-white/50 backdrop-blur-xl border-white/60 shadow-xl rounded-[2.5rem] overflow-hidden relative">
                        ...
                        <CardContent className="px-4 sm:px-8 pb-6 sm:pb-8 pt-0 flex flex-col items-start min-h-[inherit]">
                            ...
                            <div className="mt-5 w-full">
                                ...
                                {profile.headline && (
                                    <h2 className="text-xl font-bold text-[#3D6EFF] mt-2">{profile.headline}</h2>
                                )}
                                    ...
                                    {ratedSkills && ratedSkills.length > 0 ? (
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {legacySkills.map((skill: string) => (
                                                <Badge key={skill} variant="secondary" className="bg-[#1B3FA0] text-white hover:bg-[#1B3FA0]/80 font-semibold px-3 py-1 rounded-full shadow-sm">
                                                    {skill}
                                                </Badge>
                                            ))}
                                        </div>
